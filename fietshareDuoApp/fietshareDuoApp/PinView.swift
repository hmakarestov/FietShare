...
class PinView: UIView {
  ...
  //  @IBOutlet var contentView: PinView!
    ...
    private let inset = UIEdgeInsets(top: 0, left: 65, bottom: 15, right: 65)  //(top: 5, left: 5, bottom: 10, right: 5) //
    ...
    private let bubbleLayer: CAShapeLayer = {
        ...
        layer.fillColor = UIColor.white.cgColor //background of Pop up
        layer.lineWidth = 1.5
        return layer
    }()
    ...
    //  pinView.translatesAutoresizingMaskIntoConstraints = false
       ...
       // btnReserve(to: contentView) // my button
